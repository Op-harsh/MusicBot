...
# Vars For API End Point (OPTIONAL - yt-dlp handles downloads directly now)
YTPROXY_URL = getenv("YTPROXY_URL", None) ## No longer required
YT_API_KEY = getenv("YT_API_KEY", None) ## No longer required
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Op-harsh/MusicBot.git",
)
